...
double verticalAlign = (tHeight - ((BOXSIZE * 1) + (padding * 4)))/3;
...
void setup() {
  ...
  createButtons();
  insertNumbers();    
  tft.fillRect(34,10,165,50,WHITE);
...
void loop() {
  ...
  retrieveTouch();
  int boxHeightRow1 = verticalAlign + (BOXSIZE*2);
  int boxHeightRow2 = secondRow + (BOXSIZE*3);
  int boxHeightRow3 = thirdRow + (BOXSIZE*4);
  int boxHeightRow4 = fourthRow + (BOXSIZE*5);
  ...
  if (Z > MINPRESSURE && Z < MAXPRESSURE) {
    ...
    createButtons();
    insertNumbers();
    //default text setup for number display on  (controla la posicion del cursor)
...
void createButtons() {
  ...
  //Second Row
  tft.fillRect(leftColPositionX, secondRowVertialAlign, BOXSIZE, BOXSIZE, GREEN);
  tft.fillRect(midColPositionX, secondRowVertialAlign, BOXSIZE, BOXSIZE, YELLOW);
  tft.fillRect(rightColPositionX, secondRowVertialAlign, BOXSIZE, BOXSIZE, BLUE);
...
void insertNumbers() {
  ...
  double firstRowCursorY  = verticalAlign + (BOXSIZE / 2);
